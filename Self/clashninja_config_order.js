...
const dnsConfig = {
    ...
    "default-nameserver": ["tls://223.5.5.5", "223.5.5.5", "119.29.29.29", "1.1.1.1", "8.8.8.8"],
...
const rules = [
    ...
    ...customRules,
    // 规则集
    "RULE-SET,security,02🎓 网络安全",
    "RULE-SET,ChinaCompanyIp,07🎯 全球直连",
    // "RULE-SET,btDownload,07🎯 全球直连",
    "RULE-SET,ChinaDirect,07🎯 全球直连",
    "RULE-SET,OpenAI,03💬 Ai平台",
    "RULE-SET,Claude,03💬 Ai平台",
    "RULE-SET,Gemini,03💬 Ai平台",
    "RULE-SET,Copilot,03💬 Ai平台",
    // "RULE-SET,Perplexity,03💬 Ai平台",
    "RULE-SET,otherai,03💬 Ai平台",
    "RULE-SET,AllAI,03💬 Ai平台",
    "RULE-SET,proxylist,01🚀 节点选择",
    "RULE-SET,SteamCN,07🎯 全球直连",
    "RULE-SET,LocalAreaNetwork,07🎯 全球直连",
    // "RULE-SET,ChinaDirect,07🎯 全球直连",
    "RULE-SET,UnBan,07🎯 全球直连",
    "RULE-SET,ChinaDomain,07🎯 全球直连",
    "RULE-SET,GoogleCN,07🎯 全球直连",
    "GEOIP,CN,07🎯 全球直连",
    // "RULE-SET,ipdirect,全局直连,no-resolve",
    // "RULE-SET,ipprivate,全局直连,no-resolve",
    // "RULE-SET,Telegram,📲 电报信息,no-resolve",
    "RULE-SET,Telegram,06🚀 国外流量,no-resolve",
    // "RULE-SET,direct,全局直连",
    // "RULE-SET,private,全局直连",
    "RULE-SET,google,10Ⓜ️ 微软服务",
    "RULE-SET,Apple,11🍎 苹果服务",
    "RULE-SET,bing,10Ⓜ️ 微软服务",
    "RULE-SET,github,10Ⓜ️ 微软服务",
    "RULE-SET,onedrive,10Ⓜ️ 微软服务",
    "RULE-SET,Microsoft,10Ⓜ️ 微软服务",
    // "RULE-SET,ai,03💬 Ai平台",
    // "RULE-SET,youtube,🌍 国外媒体",
    // "RULE-SET,ProxyMedia,🌍 国外媒体",
    "RULE-SET,youtube,06🚀 国外流量",
    "RULE-SET,ProxyMedia,06🚀 国外流量",
    // "RULE-SET,netflix_ip,Netflix",
    // "RULE-SET,netflix_site,Netflix",
    // "RULE-SET,tiktok,TikTok",
    // "RULE-SET,adobe,Adobe",
    "RULE-SET,pornhub,01🚀 节点选择",
    ...
    "RULE-SET,BanAD,12🛑 全球拦截",
    "RULE-SET,BanProgramAD,12🛑 全球拦截",
    // "RULE-SET,BanProgramAD,🍃 应用净化",
    "RULE-SET,ProxyLite,01🚀 节点选择",
    // "RULE-SET,ProxyGFWlis,06🚀 国外流量",

    "RULE-SET,ProxyGFWlist,06🚀 国外流量",
...
const ruleProviders = {
    ...
    google: {
        ...
        url: "https://github.com/mmutj/ACL4SSR/blob/4aade40fa06b93906be2d7c95beec338afb0b61b/Self/list/google_mrs.txt",
        // format: "mrs",
        format: "text",
    ...
    bing: {
        ...
        url: "https://github.com/mmutj/ACL4SSR/blob/4aade40fa06b93906be2d7c95beec338afb0b61b/Self/list/bing_mrs.txt",
        // "format": "mrs",
        "format": "text",
        path: "./ruleset/bing.txt",
    },
    github: {
        ...ruleProviderCommon,
        behavior: "domain",
        // url: "https://github.com/MetaCubeX/meta-rules-dat/raw/refs/heads/meta/geo/geosite/github.mrs",
        url: "https://github.com/mmutj/ACL4SSR/blob/037cf0f3d469327e68838d6b4282ef4edb704517/Self/list/github_mrs.txt",
        "format": "text",
    ...
    onedrive: {
        ...
        url: "https://github.com/mmutj/ACL4SSR/blob/4aade40fa06b93906be2d7c95beec338afb0b61b/Self/list/onedrive_mrs.txt",
        "format": "text",
    ...
    youtube: {
        ...
        url: "https://github.com/mmutj/ACL4SSR/blob/4aade40fa06b93906be2d7c95beec338afb0b61b/Self/list/youtube_mrs.txt",
        "format": "text",
    ...
    pornhub: {
        ...
        url: "https://github.com/mmutj/ACL4SSR/blob/4aade40fa06b93906be2d7c95beec338afb0b61b/Self/list/pornhub_mrs.txt",
        "format": "text",
...
const proxyGroups = [
    {
        ...
        "name": "01🚀 节点选择",
        "type": "select",
        proxies: ["09♻️ 自动选择", "DIRECT", "08🔯 故障转移"],
        "include-all": true,
    ...
    },
    {
        ...
        name: "02🎓 网络安全",
        "type": "select",
        // proxies: ["09♻️ 自动选择", "01🚀 节点选择", "04🚀 节点选择", "🛩️ 手动选择备用"],
        proxies: ["08🔯 故障转移", "01🚀 节点选择", "04🚀 节点选择"],
        "include-all": true,
    ...
    // },
    {
        ...
        "type": "select",
        proxies: ["08🔯 故障转移", "09♻️ 自动选择"],
        filter: "(?i)(深|沪|呼|京|广|杭)美|美国|纽约|洛杉矶|United States|USA|Los Angeles|Silicon Valley|新加坡|🇸🇬|SG|狮城|Singapore|台湾|🇹🇼|tw|taiwan|tai wan",
        // proxies: ["延迟选优", "手动选择"], 
        "include-all": true,
    },
    {
        ...
        timeout: 3000,
        "exclude-filter": "流量|Traffic|过期|时间|Expire|套餐|到期|有效",
        filter: "(?i)(深|沪|呼|京|广|杭)美|美国|纽约|洛杉矶|United States|USA|Los Angeles|Silicon Valley|(?i)港|hk|hongkong|hong kong|新加坡|🇸🇬|SG|狮城|Singapore|台湾|🇹🇼|tw|taiwan|tai wan",
        // "icon": "https://fastly.jsdelivr.net/gh/Koolson/Qure@master/IconSet/Color/Airport.png",
    },
    {
        ...groupBaseOption,
    ...
    //     name: "📲 电报信息",
    //     "type": "select",
    //     proxies: ["09♻️ 自动选择", "01🚀 节点选择", "04🚀 节点选择", "fallback"], 
    //     // "include-all": true,
    // },
    {
        ...groupBaseOption,
        name: "10Ⓜ️ 微软服务",
        "type": "select",
        proxies: ["09♻️ 自动选择", "01🚀 节点选择", "04🚀 节点选择", "08🔯 故障转移"], 
        // "include-all": true,
    },
    // {
    //     ...groupBaseOption,
    ...
    // },
    {
        ...
        name: "11🍎 苹果服务",
        "type": "select",
        proxies: ["09♻️ 自动选择", "01🚀 节点选择", "04🚀 节点选择", "08🔯 故障转移", "07🎯 全球直连"], 
        // "include-all": true,
    },
    {
        ...groupBaseOption,
        name: "07🎯 全球直连",
        "type": "select",
        proxies: ["DIRECT", "01🚀 节点选择", "04🚀 节点选择"], 
        // "include-all": true,
    },
    {
        ...groupBaseOption,
    ...
    },
    {
        ...
        name: "12🛑 全球拦截",
        "type": "select",
        proxies: ["REJECT", "01🚀 节点选择", "04🚀 节点选择", "07🎯 全球直连"], 
        // "include-all": true,
    },
    // {
    //     ...groupBaseOption,
    ...
    },
    {
        ...
        name: "GLOBAL",
        "type": "select",
        proxies: ["01🚀 节点选择", "02🎓 网络安全", "03💬 Ai平台", "04🚀 节点选择", "05🐟 漏网之鱼", "06🚀 国外流量", "07🎯 全球直连", "08🔯 故障转移", "09♻️ 自动选择", "10Ⓜ️ 微软服务", "11🍎 苹果服务", "12🛑 全球拦截"], 
        "exclude-filter": "流量|Traffic|过期|时间|Expire|套餐|到期|有效",
        "include-all": true,
    },
  ]
