...
const rules = [
    ...
    "RULE-SET,ChinaCompanyIp,06🎯 全球直连",
    // "RULE-SET,btDownload,06🎯 全球直连",
    "RULE-SET,ChinaDirect,06🎯 全球直连",
    ...
    "RULE-SET,SteamCN,06🎯 全球直连",
    "RULE-SET,LocalAreaNetwork,06🎯 全球直连",
    // "RULE-SET,ChinaDirect,06🎯 全球直连",
    "RULE-SET,UnBan,06🎯 全球直连",
    "RULE-SET,ChinaDomain,06🎯 全球直连",
    "RULE-SET,GoogleCN,06🎯 全球直连",
    "GEOIP,CN,06🎯 全球直连",
    // "RULE-SET,ipdirect,全局直连,no-resolve",
    // "RULE-SET,ipprivate,全局直连,no-resolve",
    // "RULE-SET,Telegram,📲 电报信息,no-resolve",
    "RULE-SET,Telegram,07🚀 国外流量,no-resolve",
    ...
    "RULE-SET,youtube,07🚀 国外流量",
    "RULE-SET,ProxyMedia,07🚀 国外流量",
    ...
    // "RULE-SET,ProxyGFWlis,07🚀 国外流量",

    "RULE-SET,ProxyGFWlist,07🚀 国外流量",
...
const proxyGroups = [
    ...
    // },
    {
        ...
        name: "11🍎 苹果服务",
        "type": "select",
        proxies: ["09♻️ 自动选择", "01🚀 节点选择", "04🚀 节点选择", "08🔯 故障转移", "06🎯 全球直连"], 
        // "include-all": true,
    },
    {
        ...groupBaseOption,
    ...
    },
    {
        ...
        name: "12🛑 全球拦截",
        "type": "select",
        proxies: ["REJECT", "01🚀 节点选择", "04🚀 节点选择", "06🎯 全球直连"], 
        // "include-all": true,
    },
    // {
    //     ...groupBaseOption,
    ...
    },
    {
        ...
        name: "GLOBAL",
        "type": "select",
        proxies: ["01🚀 节点选择", "02🎓 网络安全", "03💬 Ai平台", "04🚀 节点选择", "05🐟 漏网之鱼", "06🎯 全球直连", "07🚀 国外流量", "08🔯 故障转移", "09♻️ 自动选择", "10Ⓜ️ 微软服务", "11🍎 苹果服务", "12🛑 全球拦截"], 
        "exclude-filter": "流量|Traffic|过期|时间|Expire|套餐|到期|有效",
        "include-all": true,
    },
  ]
