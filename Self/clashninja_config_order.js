const customRules = [
    ...
    // "geosite:google,youtube,telegram,gfw,geolocation-!cn,🚀 节点选择",
...
const rules = [
    ...
    "RULE-SET,Telegram,🚀 国外流量,no-resolve",
...
const proxyGroups = [
    ...
    //     name: "📲 电报信息",
    //     "type": "select",
    //     proxies: ["♻️ 自动选择", "🚀 节点选择", "✈️ 手动选择", "🔯 故障转移"], 
    //     // "include-all": true,
    // },
    {
        ...groupBaseOption,
    ...
    // },
    {
        ...
        name: "🍎 苹果服务",
        "type": "select",
        proxies: ["♻️ 自动选择", "🚀 节点选择", "✈️ 手动选择", "🔯 故障转移", "🎯 全球直连"], 
        // "include-all": true,
    },
    {
        ...groupBaseOption,
    ...
    },
    {
        ...
        name: "🛑 全球拦截",
        "type": "select",
        proxies: ["REJECT", "🚀 节点选择", "✈️ 手动选择", "🎯 全球直连"], 
        // "include-all": true,
    },
    // {
    //     ...groupBaseOption,
    ...
    },
    {
        ...
        name: "GLOBAL",
        "type": "select",
        proxies: ["🚀 节点选择", "✈️ 手动选择", "🔯 故障转移", "♻️ 自动选择", "🎓 网络安全", "💬 Ai平台", "🐟 漏网之鱼", "🎯 全球直连", "🚀 国外流量", "Ⓜ️ 微软服务", "🍎 苹果服务", "🛑 全球拦截"], 
        "exclude-filter": "流量|Traffic|过期|时间|Expire|套餐|到期|有效",
        "include-all": true,
    },
  ]
